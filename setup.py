...
PACKAGE_NAME = 'file-cache'
PACKAGE_DOWNLOAD_URL = 'https://github.com/Nekmo/file-cache/archive/master.zip'  # .tar.gz
URL = 'https://github.com/Nekmo/file-cache'  # Project url
STATUS_LEVEL = 1  # 1:Planning 2:Pre-Alpha 3:Alpha 4:Beta 5:Production/Stable 6:Mature 7:Inactive
KEYWORDS = ['cache', 'file', 'file-cache']
